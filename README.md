...
function niceLevelLabel(id){
  if(id === "1.1") return "Level 1.1";
  if(id === "1.2") return "Level 1.2";
  if(id === "1.3") return "Level 1.3";
  if(id === "2.1") return "Level 2.1";
  if(id === "2.2") return "Level 2.2";
  if(id === "2.3") return "Level 2.3";
  if(id === "3.1") return "Level 3.1";
  if(id === "3.2") return "Level 3.2";
  if(id === "3.3") return "Level 3.3";
  return "Level " + id;
}

function selectedLevelsText(){
  const list = Array.from(activeLevels);
  list.sort((a,b)=>{
  ...
  if(list.length === 0) return "Levels  Manual selection";
  return "Levels  " + list.map(niceLevelLabel).join(", ");
}
...
function generateWorksheets(pool){
  let pagesHtml = "";
  const levelsLine = escapeHtml(selectedLevelsText());
      ...
      <div class="printPage">
        <div class="centerFrame">
          <div class="worksheet">
            ...
            <div class="worksheetLevels">${levelsLine}</div>
